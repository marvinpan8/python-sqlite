...
engine = create_engine("sqlite:///file:memdb1?mode=memory&cache=shared&check_same_thread=false&uri=true",
...
engine2 = create_engine("sqlite:///file:memdb1?mode=memory&cache=shared&check_same_thread=false&uri=true",
                       echo=True, poolclass=StaticPool)
frame.to_sql('colors', engine2, if_exists="replace")
